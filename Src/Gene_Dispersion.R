...
###### <= 2.3-13 to be compatible with scde package.
###### NOTE 1:Data does not need logarithmic transformation
rm(list=ls())
...
##### Cleaning data, minimum of genes per sample=1000, minimum of
