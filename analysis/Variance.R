...
######    overdispersed genes, in this study the number of choosen genes were
...
# Ploting Variance Cumulative Sum
png(file='./results/plots/Variance_Cumulative_Sum.png')
  ...
  dev.off()
# Ploting Variance Range proportion given the genes number
